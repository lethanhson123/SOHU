...
namespace SOHU.MVC.Controllers
{
    ...
    {
        private readonly IInvoicePaymentResposistory _invoicePaymentResposistory;

        public InvoicePaymentController(IInvoicePaymentResposistory invoicePaymentResposistory)
        {
